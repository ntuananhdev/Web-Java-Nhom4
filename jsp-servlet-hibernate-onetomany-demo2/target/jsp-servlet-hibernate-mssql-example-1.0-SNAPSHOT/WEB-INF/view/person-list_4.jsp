                    ...
                    <ul class="nav navbar-nav" style="height: 150px">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav navbar-nav" >
                                <li class="active" style="height:30px"> <a href="#">Quần Nam </a></li>
                                <li class="active" style="height: 20px"> <a href="#">Áo Nam</a></li>
                            </ul>
                        </li>
                
                        <li class="active"><a href="#">Chính sách</a>
                            <ul class="nav navbar-nav" style="width: 220px;height: 100px">
                                <li class="active" style="width: 200px;height: 20px"><a href="#">Hướng dẫn mua hàng </a></li>
                                <li class="active" style="width: 200px;height: 20px"><a href="#">Chính sách thanh toán</a></li>
                                <li  class="active" style="width: 200px;height: 20px"><a href="#">Chính sách vận chuyển</a></li>
                                <li class="active" style="width: 200px; height: 20px"><a href="#">Chính sách bảo hành</a></li>
                            </ul>
                        </li>
                        <li class="active"><a href="#">Giao Hàng</a></li>
